...
?>
<?php if(isset($gyass->messages['upload']) && is_array($gyass->messages['upload']) && count($gyass->messages['upload']) > 0): ?>
<div class="updated">
<p class="">
<?php foreach($gyass->messages['upload'] as $msg): ?>
	<span><?php print $msg; ?></span><br/>
<?php endforeach;?>
</p>
</div>
<?php endif; ?>
<script type="text/javascript">var yass_current_album_id = <?php print $album['album_id']; ?>;</script>
<div class="dataTable_wrapper">
	<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
		...
		<?php yass_get_table_actions(array('yass_bulk_delete_images' => 'Delete', 
											'yass_bulk_disable_images' => 'Disable', 
											'yass_bulk_enable_images' => 'Enable')); ?>
	</div>
	...
	<tbody>
	<?php require_once YSS_PLUGIN_DIR . '/html/images_rows.php'; ?>
	</tbody>
	</table>
...
<div id="single_upload" class="tab_content">
	<form id="single_upload_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="yass_single_image_upload" />
...
-->
	...
	var yass_upload_dir = "<?php  /* add the replace "\\" to work on windows server */  print str_replace("\\","/",yass_get_album_dir($album['album_id'])); ?>";
	var yass_secw = "<?php 
	global $wpdb;
	$query = "SELECT txt FROM {$wpdb->prefix}yass_misc WHERE ione=1 AND itwo=1 AND ithree=1 LIMIT 1";
